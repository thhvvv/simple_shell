 ...
 * with full command path
 * @args: the array the command and it's arguments
 * @full_path: string the full path of the command
 * Return: the array the command with the full path
 */
